    ...
    addMenuInstruction() {
        ...
        this.tweens.add({
            ...
            onComplete: () => {
                ...
                this.textInstruction = this.add.text(29 / 100 * config.width, 30 / 100 * config.height, "", { fontSize: '70px', fontFamily: 'Times New Roman', fill: 'red' }).setDepth(5);
                setTimeout(() => {
                    this.addHome() 
                }, 2000);
                setTimeout(() => {
    ...
    displayQuestions() {
        ...
        this.tweens.add({
            ...
            onComplete:  ()=> {
               ...
               this.add.text(30 / 100 * config.width, 30 / 100 * config.height, "Press Any key to restart", { fontSize: '35px', fontFamily: 'Times New Roman', fill: 'red' }).setDepth(5);
